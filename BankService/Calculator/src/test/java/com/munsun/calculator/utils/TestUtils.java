...
public class TestUtils {
    ...
    public static ScoringDataDto getScoringDataDtoNotBinaryGender() {
        return new ScoringDataDto(
                ...
                "Sunchalyaev",
                "Raisovich",
                ScoringDataDto.GenderEnum.NON_BINARY,
                "msunchalyaev@gmail.com",
                LocalDate.of(1998, 5, 26),
                "1234",
                "567890",
    ...
    public static ScoringDataDto getScoringDataDtoUnemployedWorkStatus() {
        return new ScoringDataDto(
                ...
                27,
                new EmploymentDto(
                        EmploymentDto.EmploymentStatusEnum.UNEMPLOYED,
                        "123456789011231212",
                        BigDecimal.valueOf(41_000),
                        EmploymentDto.PositionEnum.MID_MANAGER,
                        19,
    ...
    public static ScoringDataDto getScoringDataDtoGreaterMaxAgeFemale() {
        return new ScoringDataDto(
                ...
                "Sunchalyaev",
                "Raisovich",
                ScoringDataDto.GenderEnum.FEMALE,
                "msunchalyaev@gmail.com",
    ...
    public static ScoringDataDto getScoringDataDtoOfTopManager() {
        return new ScoringDataDto(
                ...
                new EmploymentDto(
                        ...
                        "123456789011231212",
                        BigDecimal.valueOf(41_000),
                        EmploymentDto.PositionEnum.TOP_MANAGER,
                        19,
                        4
                ),
                "79873022923",
    ...
    public static ScoringDataDto getScoringDataDtoMiddleManager() {
        return new ScoringDataDto(
                ...
                LocalDate.of(2014, 8, 10),
                "ГУ МВД РОССИИ",
                ScoringDataDto.MaritalStatusEnum.MARRIED,
                27,
                new EmploymentDto(
                        EmploymentDto.EmploymentStatusEnum.SELF_EMPLOYED,
                        "123456789011231212",
    ...
    public static ScoringDataDto getScoringDataDtoHomeless() {
        return new ScoringDataDto(
                ...
                0,
                new EmploymentDto(
                        EmploymentDto.EmploymentStatusEnum.UNKNOWN,
                        "123456789011231212",
                        BigDecimal.ZERO,
                        EmploymentDto.PositionEnum.WORKER,
                        19,
                        0
                ),
                "79873022923",
